    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <select name="blog_category_id" type="type" class="form-select" aria-label="Default select example">
            ...
            <!-- end row -->
                ...
                <input type="submit" class="btn btn-info waves-effect waves-light" value="Submit Blog">
            </form>
